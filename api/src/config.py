...
GROQ_API_KEY = getenv_checked("GROQ_API_KEY")
GROQ_CHAT_MODEL = getenv_checked("GROQ_CHAT_MODEL")
...
GROQ_TRANSCRIPTION_MODEL = getenv_checked("GROQ_TRANSCRIPTION_MODEL")
TTS_CHUNK_SIZE = 2048
